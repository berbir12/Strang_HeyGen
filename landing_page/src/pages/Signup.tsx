    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-[400px] relative z-10 text-center">
          <div className="bg-card border border-border rounded-2xl shadow-xl p-10 space-y-5">
            ...
            <Link
              ...
              className="inline-block w-full glow-button py-3 text-sm text-center"
            >
              Back to sign in
            </Link>
          </div>
      ...
      <div className="w-full max-w-[400px] relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-1.5 text-muted-foreground text-sm">
            Turn any text into an explainer video
          </p>
        </div>
